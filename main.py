...
class Main(object):
    ...
    def add_model(self):
        ...
        """
        if self.p.model.lower() == 'interacte':
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', dest='model', default='InteractE', help='Model Name')
    ...
    parser.add_argument("--ent_embed_dim",	type=int,              	default=100,
                        help='Embedding dimension for entity')
    parser.add_argument("--rel_embed_dim",	type=int,              	default=100,
                        help='Embedding dimension for relation')
